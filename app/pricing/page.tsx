      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 md:py-20 lg:px-8">
        <div className="grid gap-8 md:grid-cols-3">
          {PRICING_TIERS.map((tier, i) => (
            <Reveal key={tier.label} delay={i * 0.06}>
              <div className="h-full rounded-2xl border border-gray-100 bg-white p-8 text-center shadow-sm transition-all hover:-translate-y-1.5 hover:shadow-xl">
                ...
                <h2 className="font-heading text-xl font-700 text-ink">
                  {tier.label}
                </h2>
        ...
        <Reveal>
          <div className="mx-auto mt-16 max-w-3xl">
            <h2 className="text-center font-heading text-2xl font-700 text-ink md:text-3xl">
            ...
            <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {DISCOUNTS.map((discount) => (
                <div key={discount.label} className="flex flex-col items-center text-center">
                  ...
                  <p className="font-heading font-700 text-ink">{discount.label}</p>
