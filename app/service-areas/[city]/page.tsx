    ...
    <div className="bg-white dark:bg-ink">
      ...
      <div className="bg-gray-light">
        <div className="mx-auto max-w-3xl px-4 py-14 text-center sm:px-6 md:py-20 lg:px-8">
          <nav aria-label="Breadcrumb" className="mb-4 text-sm text-gray-500 dark:text-white/60">
            <Link href="/" className="hover:text-gold">Home</Link>
            <span className="mx-2">/</span>
            <Link href="/service-areas" className="hover:text-gold">Service Areas</Link>
            <span className="mx-2">/</span>
            <span className="text-gray-700 dark:text-white/80">{city.name}</span>
          </nav>
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600 dark:text-white/70">{city.blurb}</p>
      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 md:py-20 lg:px-8">
        <h2 className="mb-6 text-center font-heading text-xl font-700 text-ink dark:text-white">
          ...
          {otherCities.map((c) => (
            <li key={c.slug}>
              ...
              >
                ...
                <span className="font-600 text-gray-700 dark:text-white/80">{c.name}</span>
              </Link>
            </li>
          ))}
        </ul>
