...
export function BeforeAfterSlider({ pairs }: BeforeAfterSliderProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl">
      <div
        ref={containerRef}
        className="relative aspect-[4/3] w-full touch-none select-none overflow-hidden rounded-2xl bg-gray-200 shadow-xl sm:aspect-[16/10]"
      ...
      <p className="mt-3 text-center text-sm font-600 text-gray-500">{pair.label}</p>
    </div>
  );
}
