...
export function ServiceCard({ icon: Icon, title, description, href = "/quote" }: ServiceCardProps) {
  return (
    <div className="group h-full rounded-2xl border border-surface-border bg-surface p-6 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-gold/40 hover:shadow-xl">
