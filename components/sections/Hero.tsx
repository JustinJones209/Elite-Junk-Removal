...
/**
 * Above-the-fold hero: the trailer photo as a full-bleed background
 ...
 * the trust-badge strip.
 */
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-ink">
      {/* Trailer photo background */}
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 md:py-20 lg:px-8 lg:py-24">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="font-heading text-4xl font-800 uppercase leading-[1.1] tracking-tight text-white sm:text-5xl lg:text-6xl">
